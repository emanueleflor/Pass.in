...
CREATE TABLE "new_check_ins" (
    ...
    CONSTRAINT "check_ins_ateendee_id_fkey" FOREIGN KEY ("ateendee_id") REFERENCES "attendees" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_check_ins" ("ateendee_id", "created_at", "id") SELECT "ateendee_id", "created_at", "id" FROM "check_ins";
